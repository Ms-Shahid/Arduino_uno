...
long unsigned int lastPress;  //unsigned indicates only positive, long stores more bits of data
int debounceTime = 20;
...
void loop() {
  ...
  {
    lastPress = millis();   //update lastPress millis records the amt of time that has trasnfered since when the program is initiated                                                
